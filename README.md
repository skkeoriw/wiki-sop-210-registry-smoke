...
```text
使用 youtube-wiki，帮我把这个 YouTube 链接跑进 skkeoriw/wiki-sop-210-registry-smoke: https://www.youtube.com/watch?v=dQw4w9WgXcQ
```
...
```bash
youtube-wiki trigger --repo skkeoriw/wiki-sop-210-registry-smoke --url 'https://www.youtube.com/watch?v=5MgBikgcWnY'
youtube-wiki trigger --repo skkeoriw/wiki-sop-210-registry-smoke --url 'https://www.youtube.com/watch?v=5MgBikgcWnY' --watch
youtube-wiki status --repo skkeoriw/wiki-sop-210-registry-smoke --pipeline-id '<pipeline_id>'
